...
document.addEventListener("DOMContentLoaded", () => {
  ...
  //create dropdown menu for priorities
...
//Action once form is submitted
 formButton.addEventListener('submit', function(e){
   e.preventDefault()
   //Find dropdown menu, value user inputted, where the task will be inserted and the li element that is created
   const dropdown = document.getElementById("dropdown")
   const task = inputBar.value
   const tasklist = document.getElementById('tasks')
   const li = document.createElement('li')
   //style li element based on priority
   li.innerText = task
   if (dropdown.value === "high"){
    ...
    //place li element with adjacent delete and edit buttons
